...
const currentFeelsLikeTemperatureNode = document.querySelector(
  "#description > div > p:first-of-type > span",
);

const currentConditionsTextNode = document.querySelector(
  "#description > div > p:nth-of-type(2)",
);

const resolvedAddressNode = document.querySelector(
  "#description > div > p:last-of-type",
);

const currentMinMaxTemperatureNodes = document.querySelectorAll(
  "#temperature-summary > div > p:first-of-type",
);

const currentConditionsDescriptionNode = document.querySelector(
  "#current-description > p",
);

const currentParameterContainers = document.querySelectorAll(
